	...
	return (
		<div>
			<div className={'flex items-center justify-between py-4 px-4'}>
				...
				>
					<li
						className={'px-3 py-3 font-Inter hover:font-bold hover:text-shadow'}
					>
					...
					>
						<Link
							href={{
								pathname: '/products/type',
								query: { type: 105, name: 'аксессуаров' },
							}}
						>
							Аксессуары
						</Link>
			...
			>
				...
				<li className={'px-1 py-3 font-Inter text-sm'}>
					<Link
						href={{
							pathname: '/products/type',
							query: { type: 106, name: 'одежды' },
